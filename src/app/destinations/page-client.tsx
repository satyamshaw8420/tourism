...
export default function DestinationsPageClient({ destinationsWithImages }: { destinationsWithImages: DestinationWithImage[] }) {
              ...
              <Card className="group hover:shadow-2xl transition-all duration-500 overflow-hidden bg-white border-0 shadow-lg hover:scale-[1.03] hover:-translate-y-2">
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute top-3 right-3 p-2.5 bg-white/90 backdrop-blur-sm rounded-full hover:bg-white transition-all duration-200 hover:scale-110 shadow-lg z-30"
                  >
                    <Heart 
                  ...
                  {destination.featured && (
                    <div className="absolute top-3 left-3 bg-gradient-to-r from-yellow-400 to-orange-500 text-white px-3 py-1 rounded-full text-xs font-bold z-30">
                      ⭐ Featured
                    </div>
                  )}
                  ...
                  {destination.location.address.includes('Jharkhand') && (
                    <div className="absolute top-3 left-3 bg-gradient-to-r from-green-500 to-teal-600 text-white px-3 py-1 rounded-full text-xs font-bold z-30">
                      🌿 Jharkhand
                    </div>
                  )}
                </div>
